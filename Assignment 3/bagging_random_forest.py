...
# by using an ensemble classifier that combines multiple decision trees, and by using Random Forest. 
...
with open('optdigits.tes', 'r') as testingFile:
    ...
    for k in range(20): #we will create 20 bootstrap samples here (k = 20). One classifier will be created for each bootstrap sample
        ...
        for bts in bootstrapSample:
            X_training.append(bts[:-1])
            Y_training.append(bts[-1])
